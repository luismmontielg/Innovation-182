			...
			<head>
				...
				<style type="text/css"><![CDATA[
						@charset "UTF-8";
							...
							.u_style #header {
								background: #E4DFDF url(/images/header/redBck.gif) top left no-repeat;}	/* Header color */
							.u_style #headerNavBar {
								...
								background-color:#519828;		/* Header Nav background */
								border-top-color:#333;		/* Header Nav top border */
							}
				...
				<div id="wrapper">
					...
					<div id="header">
						<div id="headerWrapper">
							<div id="headerLeft">
								<a href="http://www.drchrono.com">
									<img style="height: 28px" src="https://d1lxka6a37cuak.cloudfront.net/site_media/cb-619ad8eb/images/logo-new.png"/>
								</a>
